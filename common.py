...
AV_SCAN_MAX_FILE_SIZE_BYTES = int(os.getenv("AV_SCAN_MAX_FILE_SIZE_BYTES", "25000000")) #default 25MB
...
AV_STATUS_SKIPPED = os.getenv("AV_STATUS_SKIPPED", "SKIPPED")
...
LD_PATH = os.getenv("LD_PATH", "./bin/ld.gold")
